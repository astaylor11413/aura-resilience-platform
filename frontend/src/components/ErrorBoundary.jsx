...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-screen bg-slate-950 text-rose-500 p-6 text-center">
          ...
          <button 
            className="mt-4 px-4 py-2 bg-rose-600 text-white rounded hover:bg-rose-500"
